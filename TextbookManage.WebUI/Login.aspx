<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="USCTAMis.WebPage.Login" %>
        ...
        <div class="row" >
            <div id="logPanel" class="span6  login form-horizontal  offset3" >
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <utm:UTMisTextBox ID="txt_UserName" runat="server" DisplayText=""
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <utm:UTMisTextBox ID="txt_Password" runat="server" TextMode="Password" />
                    </div>
                </div>               
                <div class="control-group">
                    <div class="controls">
                         <utm:UTMisButton ID="bt_Login" runat="server"  ButtonType="LinkButton" Text="登录教务系统" Icon-PrimaryIconUrl="~\images\application_go.png" OnClick="bt_Login_Click" />
                    </div>
                </div>
                <hr />
                <p>
