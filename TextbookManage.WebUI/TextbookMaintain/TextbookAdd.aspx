<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TextbookAdd.aspx.cs" Inherits="TextbookManage.WebUI.TextbookMaintain.TextbookAdd" %>
                        ...
                        <tr>
                            <td class="border">
                                <utm:UTMisLabel ID="clblType" runat="server" Style="font-family: Arial; font-size: medium"
                                    Text="教材类型"></utm:UTMisLabel>
                            </td>
                            <td class="border"><span class="style1">*</span></td>
                            <td class="border" align="left" colspan="5">
                                <utm:UTMisTextBox ID="ctxtType" runat="server" Height="100%" SkinID="Changeable" Width="500px">
                                </utm:UTMisTextBox>
                            </td>
                            <td class="border" style="color: Gray;" align="left">
