            ...
            <utm:UTMisGrid runat="server" ID="cgrdApprovalRecord" SkinID="NoExport" OnBeforeDataBind="cgrdApprovalRecord_BeforeDataBind" >
                <MasterTableView>
                    <Columns>
                        ...
                        <telerik:GridBoundColumn HeaderText="审核部门" DataField="Division">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn HeaderText="审核人" DataField="Auditor">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn HeaderText="审核日期" DataField="ApprovalDate">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn HeaderText="审核意见" DataField="Suggestion">
                        </telerik:GridBoundColumn>
