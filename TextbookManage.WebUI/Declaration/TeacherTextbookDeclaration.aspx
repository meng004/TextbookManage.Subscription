<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TeacherTextbookDeclaration.aspx.cs"
    Inherits="TextbookManage.WebUI.Declaration.TeacherTextbookDeclaration" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <utm:UTMisToolBar ID="UTMisToolBar1" runat="server" SkinID="Long">
            <Items>
                <telerik:RadToolBarButton Text="帮助" runat="server" ImageUrl="~/Img/tlb_Help.png">
                </telerik:RadToolBarButton>
            </Items>
        </utm:UTMisToolBar>
        <utm:UTMisTabStrip ID="UTMisTabStrip1" runat="server" MultiPageID="mp" SkinID="Long">
            <Tabs>
                <utm:UTMisTab runat="server" Text="教师用书申报" PageViewID="pvTeacher" Selected="true"></utm:UTMisTab>
            </Tabs>
        </utm:UTMisTabStrip>
        <utm:UTMisMultiPage ID="mp" runat="server" SkinID="Long">
            <utm:UTMisPageView ID="pvTeacher" runat="server">
                <table>
                    <tr>
                        <td rowspan="2">
                                ...
                                <ul>
                                    <li>
                                        <utm:UTMisComboBox runat="server" ID="ccmbSchool" SkinID="cmb200" AutoPostBack="true"
                                            DataTextField="Name" DataValueField="SchoolId" Label="学院" IsMaintainSelectedValue="true"
                                        ...
                                        <utm:UTMisComboBox runat="server" ID="ccmbDepartment" SkinID="cmb180" AutoPostBack="true"
                                            DataTextField="Name" DataValueField="DepartmentId" Label="教研室" IsMaintainSelectedValue="true"
                                    ...
                                    <li>
                                        <utm:UTMisComboBox runat="server" ID="ccmbCourse" SkinID="AutoSize" AutoPostBack="true"
                                            DataTextField="NumAndName" DataValueField="CourseId" Width="300" Label="课程" IsMaintainSelectedValue="true"
                                        ...
                                        <telerik:RadButton runat="server" ID="dbtnQuery" Text="查询" OnClick="cbtnQuery_Click" CausesValidation="false" />
                                    </li>
                                </ul>

                                <utm:UTMisGrid runat="server" ID="cgrdTeachingClassList" SkinID="NoExport" Height="420px" Width="500px" CheckControlID="cchkTeachingClass"
                                    OnBeforeDataBind="cgrdTeachingClassList_BeforeDataBind" CellSpacing="0" Culture="zh-CN" GridLines="None" IsCancelDataBind="False" IsPersistCheckState="False" PersistPageIndex="0">
                                    <MasterTableView>
                                        <Columns>
                                            ...
                                            <telerik:GridTemplateColumn HeaderText="教学班编号" DataField="TeachingTaskNum">
                                                <ItemTemplate>
                        ...
                        <td>
                            ...
                            <div>
                                ...
                                <telerik:RadButton runat="server" ID="cbtnQueryBook" Text="查询" OnClick="cbtnQueryBook_Click" CausesValidation="false" />
                                ...
                                <utm:UTMisGrid runat="server" ID="cgrdTextbookList" SkinID="NoExport" Height="380" CheckControlID="cchkTextbook"
                                    ...
                                    <MasterTableView AllowPaging="true" PageSize="10" EnableNoRecordsTemplate="true" NoMasterRecordsText="没有数据可以显示">
                                        ...
                                        <Columns>
                                            ...
                                            <telerik:GridBoundColumn HeaderText="教材编号" DataField="Num" HeaderStyle-Width="70">
                                            </telerik:GridBoundColumn>
                        ...
                        <td>
                            ...
                            <div>
                                <ul>
                                    ...
                                    <li>
                                        <b style="color: red">*</b>
                                        <utm:UTMisTextBox runat="server" ID="ctxtAmount" Text="1" SkinID="txt200" Label="申报数量">
                                        </utm:UTMisTextBox>
                                        <utm:UTMisCheckBox runat="server" ID="chkIsSelfCompile" Text="不需要教材" AutoPostBack="true"
                                            OnBeforeCheckedChange="chkIsSelfCompile_BeforeCheckedChange"></utm:UTMisCheckBox>
                                        <utm:UTMisButton runat="server" ID="cbtnConfirm" Text="保存" OnBeforeClick="cbtnConfirm_Click" OnAfterClick="cbtnConfirm_AfterClick" ValidationGroup="contactGroup"
                                    ...
                                    <li>
                                        ...
                                        <asp:RangeValidator ID="RangeValidator1" runat="server" ErrorMessage="申报数量应大于0小于1000，如：1"
                                            ControlToValidate="ctxtAmount" Display="None" ValidationGroup="contactGroup" MinimumValue="1" MaximumValue="1000" Type="Integer"></asp:RangeValidator>
        ...
        <telerik:RadWindowManager ID="RadWindowManager1" runat="server">
            <Windows>
                <telerik:RadWindow ID="wdw_TextbookDetailMessage" runat="server" Top="150" Left="350" Modal="true" ReloadOnShow="true">
                </telerik:RadWindow>
            </Windows>
