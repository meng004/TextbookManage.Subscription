...
{
    public partial class StudentTextbookDeclaration : USCTAMis.Web.WebControls.Page
    {
        ...
        protected void cchkCheckAll_CheckedChanged(object sender, EventArgs e)
        {
            ...
            cgrdTeachingClassList.SetAllCheckControlState(chk.Checked);
            //更新申报数量
            CalculateDeclarationCount();
        }
