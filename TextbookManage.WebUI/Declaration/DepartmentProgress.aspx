            ...
            <utm:UTMisMultiPage runat="server" ID="mp_QueryDeclaration">
                <utm:UTMisPageView ID="pv_QueryDeclaration" runat="server">
                    <table>
                        <tr>
                            <td>
                                <telerik:RadComboBox runat="server" ID="ccmbDepartment" AutoPostBack="true" SkinID="cmb200" Width="300" Label="教研室"
                                    DataTextField="Name" DataValueField="DepartmentId"
                                    OnDataBinding="ccmbDepartment_DataBinding"
                                    OnDataBound="ccmbDepartment_DataBound"
                    ...
                    <utm:UTMisGrid runat="server" ID="cgrdDeclarationList" SkinID="NoExport" 
                        OnBeforeDataBind="cgrdDeclarationList_BeforeDataBind" 
                        OnItemDataBound="cgrdDeclarationList_ItemDataBound">
...
<%--                                <telerik:GridBoundColumn DataField="DepartmentName" HeaderText="教研室名称" HeaderStyle-Width="120">
                                ...
                                <telerik:GridBoundColumn DataField="CourseName" HeaderText="课程名称" HeaderStyle-Width="200">
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn DataField="DataSignName" HeaderText="数据标识">
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn DataField="TotalCount" HeaderText="教学班总数" HeaderStyle-Width="40">
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn DataField="FinishedCount" HeaderText="已完成申报数" HeaderStyle-Width="40">
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn DataField="RestCount" HeaderText="未完成申报数" HeaderStyle-Width="40">
                                </telerik:GridBoundColumn>
