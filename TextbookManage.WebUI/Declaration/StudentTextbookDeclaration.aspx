        ...
        <telerik:RadCodeBlock runat="server" ID="RadCodeBlock1">
            <script type="text/javascript">
                ...
                function OnRequestDeclaration(TeachingClassNum) {
                    ...
                    oWnd.show();
                    oWnd.setSize(820, 400);
                }

                function OnSubmit() {
                    var btn = $find("<%=cbtnConfirm.ClientID%>");
                    btn.enable = false;
                }
            </script>
        </telerik:RadCodeBlock>

        <utm:UTMisToolBar runat="server" ID="tlb_Help" SkinID="Long">
            <Items>
                <telerik:RadToolBarButton runat="server" CommandName="help" Text="帮助" ImageUrl="~/Img/tlb_Help.png"></telerik:RadToolBarButton>
            </Items>
        </utm:UTMisToolBar>

        <utm:UTMisTabStrip runat="server" ID="mp_StudentDaclaration" MultiPageID="mp_Student" SkinID="Long">
            <Tabs>
                <utm:UTMisTab runat="server" PageViewID="pv_Student" Text="课程用书申报" Selected="True"></utm:UTMisTab>
            </Tabs>
        </utm:UTMisTabStrip>

        <utm:UTMisMultiPage runat="server" ID="mp_Student" SkinID="Long">
                    ...
                    <tr>
                        <td rowspan="2">
                            ...
                            <div>
                                <ul>
                                    <li>
                                        <telerik:RadComboBox runat="server" ID="ccmbSchool" SkinID="cmb200" AutoPostBack="true"
                                            DataTextField="Name" DataValueField="SchoolId" Label="学院" IsMaintainSelectedValue="true"
                                            OnDataBinding="ccmbSchool_BeforeDataBind" OnDataBound="ccmbSchool_SelectedIndexChanged"
                                            OnSelectedIndexChanged="ccmbSchool_SelectedIndexChanged">
                                        </telerik:RadComboBox>
                                        <telerik:RadComboBox runat="server" ID="ccmbDepartment" SkinID="cmb180" AutoPostBack="true"
                                            DataTextField="Name" DataValueField="DepartmentId" Label="教研室" IsMaintainSelectedValue="true"
                                            OnDataBinding="ccmbDepartment_BeforeDataBind" OnDataBound="ccmbDepartment_SelectedIndexChanged"
                                            OnSelectedIndexChanged="ccmbDepartment_SelectedIndexChanged">
                                        </telerik:RadComboBox>
                                    </li>
                                    <li>
                                        <telerik:RadComboBox runat="server" ID="ccmbCourse" SkinID="cmb200" AutoPostBack="true"
                                            DataTextField="NumAndName" DataValueField="CourseId" Width="250" Label="课程" IsMaintainSelectedValue="true"
                                            OnDataBinding="ccmbCourse_BeforeDataBind" OnDataBound="ccmbCourse_SelectedIndexChanged"
                                    ...
                                    <MasterTableView>
                                        <Columns>
                                            ...
                                            <telerik:GridTemplateColumn HeaderText="学生用书">
                                                <ItemTemplate>
                                                    <a href="#" onclick="OnRequestDeclaration('<%#Eval("TeachingTaskNum")%>')">
                        ...
                        <td>
                            ...
                            <div>
                                <ul>
                                    ...
                                    <li>
                                        <b style="color: red">*</b>
                                        <utm:UTMisTextBox runat="server" ID="ctxtAmount" SkinID="txt200" Label="申报数量" Text="1" EmptyMessage="1" >
                                        </utm:UTMisTextBox>
                                        ...
                                        <telerik:RadButton runat="server" ID="cbtnConfirm" Text="保存" OnClientClicked="OnSubmit();return false;" OnClick="cbtnConfirm_Click" ValidationGroup="contactGroup"
