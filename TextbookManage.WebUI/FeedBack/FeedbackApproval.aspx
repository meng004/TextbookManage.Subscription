<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FeedbackApproval.aspx.cs" Inherits="TextbookManage.WebUI.Feedback.FeedbackApproval" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <utm:UTMisTabStrip ID="CPMisTabStrip1" runat="server" MultiPageID="mp_Approval">
            <Tabs>
                <utm:UTMisTab runat="server" Text="审核订单回告" PageViewID="pv_Approval" Selected="true">
                </utm:UTMisTab>
            </Tabs>
        </utm:UTMisTabStrip>
        ...
        <utm:UTMisMultiPage ID="mp_Approval" runat="server" SkinID="Long">
            <utm:UTMisPageView ID="pv_Approval" runat="server">
                <table>
                    <tr>
                        <td>
                            <utm:UTMisLabel ID="lbl_School" runat="server" Text="书商：">
                            </utm:UTMisLabel>
                        </td>
                        <td>
                            <telerik:RadComboBox ID="ccmbSchool" runat="server" AutoPostBack="true"
                ...
                <utm:UTMisGrid ID="cgrdDeclaration" SkinID="NoExport" runat="server" CheckControlID="cchkSelectSingle" OnBeforeDataBind="cgrdDeclaration_BeforeDataBind">
                    <MasterTableView EnableNoRecordsTemplate="true" NoMasterRecordsText="没有数据可以显示" AllowPaging="true" PageSize="10">
                        ...
                        <Columns>
                            ...
                            <telerik:GridBoundColumn HeaderText="教材编号" DataField="TextbookNum" HeaderStyle-Width="60">
                            </telerik:GridBoundColumn>
                            <telerik:GridTemplateColumn HeaderText="教材名称" DataField="TextbookName" HeaderStyle-Width="160">
                                <ItemTemplate>
                            ...
                            <telerik:GridBoundColumn HeaderText="征订数量" DataField="SubscriptionCount" HeaderStyle-Width="60">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn HeaderText="回告人" DataField="Person" HeaderStyle-Width="50"></telerik:GridBoundColumn>
                            <telerik:GridBoundColumn HeaderText="回告日期" DataField="FeedbackDate" HeaderStyle-Width="100"></telerik:GridBoundColumn>
                            <telerik:GridBoundColumn HeaderText="回告状态" DataField="FeedbackState" HeaderStyle-Width="50"></telerik:GridBoundColumn>
                            <telerik:GridTemplateColumn HeaderText="回告说明" DataField="Remark">
                            </telerik:GridTemplateColumn>
                          </Columns>
                    </MasterTableView>
