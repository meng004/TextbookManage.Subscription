<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BooksellerOrderByTextbook.aspx.cs" Inherits="CPMis.WebPage.ReportViewsUI.Orders.BooksellerOrderByTextbook" %>
...
<body>
    ...
    <div class="div1">
        <cp:CPMisTabStrip ID="CPMisTabStrip1" runat="server" MultiPageID="mp" SkinID="Long">
            <Tabs>
                <cp:CPMisTab runat="server" Text="按教材查询书商订单">
                </cp:CPMisTab>
            </Tabs>
        </cp:CPMisTabStrip>
            ...
            <cp:CPMisPageView ID="CPMisPageView1" runat="server" SkinID="Long">
                ...
                <div>
                    <rsweb:ReportViewer ID="ReportViewer1" runat="server">
                        <LocalReport ReportPath="ReportViews\Orders\BooksellerOrderByTextbook.rdlc">
                            <DataSources>
                                <rsweb:ReportDataSource DataSourceId="sqlBooksellerOrderByTextbookAndBooksellerID" Name="DataSet1" />
                            </DataSources>
                        </LocalReport>
                    </rsweb:ReportViewer>
                    <asp:SqlDataSource ID="sqlBooksellerOrderByTextbookAndBooksellerID" runat="server" ConnectionString="<%$ ConnectionStrings:TbMISConnectionString %>"
                        SelectCommand="prReportGetBooksellerOrderByTextbookAndBooksellerID" SelectCommandType="StoredProcedure">
                    </asp:SqlDataSource>
