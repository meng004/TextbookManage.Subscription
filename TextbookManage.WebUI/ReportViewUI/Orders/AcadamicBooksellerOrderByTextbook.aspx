<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AcadamicBooksellerOrderByTextbook.aspx.cs" Inherits="CPMis.WebPage.ReportViewsUI.Orders.AcadamicBooksellerOrderByTextbook" %>
            ...
            <cp:CPMisPageView ID="CPMisPageView1" runat="server" SkinID="Long">
                ...
                <div>
                    <rsweb:ReportViewer ID="ReportViewer1" runat="server">
                        <LocalReport ReportPath="ReportViews\Orders\AcadamicBooksellerOrderByTextbook.rdlc">
                            <DataSources>
                                <rsweb:ReportDataSource DataSourceId="sqlBooksellerOrderByTextbook" Name="DataSet1" />
                            </DataSources>
                        </LocalReport>
                    </rsweb:ReportViewer>
                    <asp:SqlDataSource ID="sqlBooksellerOrderByTextbook" runat="server" ConnectionString="<%$ ConnectionStrings:TbMISConnectionString %>"
                        SelectCommand="prReportGetBooksellerOrderByTextbook" SelectCommandType="StoredProcedure">
                    </asp:SqlDataSource>
