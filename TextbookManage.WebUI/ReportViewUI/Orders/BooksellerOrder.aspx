<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BooksellerOrder.aspx.cs" Inherits="CPMis.WebPage.ReportViewsUI.Orders.BooksellerOrder" %>
            ...
            <cp:CPMisPageView ID="CPMisPageView1" runat="server" SkinID="Long">
                ...
                <div>
                    <rsweb:ReportViewer ID="ReportViewer1" runat="server">
                        <LocalReport ReportPath="ReportViews\Orders\BooksellerOrder.rdlc">
                            <DataSources>
                    ...
                    <asp:SqlDataSource ID="sqlBooksellerOrderBySchoolID" runat="server" ConnectionString="<%$ ConnectionStrings:TbMISConnectionString %>"
                        SelectCommand="prReportGetBooksellerOrderBySchoolIDAndBooksellerID" SelectCommandType="StoredProcedure">
                    </asp:SqlDataSource>
                    <asp:SqlDataSource ID="sqlBooksellerOrder" runat="server" ConnectionString="<%$ ConnectionStrings:TbMISConnectionString %>"
                        SelectCommand="prReportGetBooksellerOrderBySchoolAndBooksellerID" SelectCommandType="StoredProcedure">
                    </asp:SqlDataSource>
                </div>
            </cp:CPMisPageView>
        </cp:CPMisMultiPage>
