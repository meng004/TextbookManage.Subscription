<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StudentTextbookReleaseDetail.aspx.cs" Inherits="CPMis.WebPage.ReportViewsUI.StudentTextbookReleaseDetail" %>
...
<body>
    ...
    <div class="div1">
        <cp:CPMisTabStrip ID="CPMisTabStrip1" runat="server" MultiPageID="mp" SkinID="Long">
            <Tabs>
                <cp:CPMisTab runat="server" Text="查询学生教材发放详单">
                </cp:CPMisTab>
            </Tabs>
        </cp:CPMisTabStrip>
            ...
            <cp:CPMisPageView ID="CPMisPageView1" runat="server" SkinID="Long">
                ...
                <div>
                    <rsweb:ReportViewer ID="ReportViewer1" runat="server">
                        <LocalReport ReportPath="ReportViews\StudentTextbookReleaseDetail.rdlc">
                            <DataSources>
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:TbMISConnectionString %>"
                        SelectCommand="prReportStudentReleaseDetailGetByTermAndClassId" SelectCommandType="StoredProcedure">
                    </asp:SqlDataSource>
                </div>
            </cp:CPMisPageView>
        </cp:CPMisMultiPage>
