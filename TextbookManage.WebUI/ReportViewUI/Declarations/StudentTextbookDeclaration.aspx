<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StudentTextbookDeclaration.aspx.cs"
    Inherits="CPMis.WebPage.ReportViewsUI.Declarations.StudentTextbookDeclaration" %>
...
<body>
    ...
    <div>
        <cp:CPMisTabStrip runat="server" MultiPageID="mp" SkinID="Long" SelectedIndex="0">
            <Tabs>
                <cp:CPMisTab runat="server" Text="打印学生用书申报">
                </cp:CPMisTab>
            </Tabs>
        </cp:CPMisTabStrip>
            ...
            <cp:CPMisPageView ID="CPMisPageView1" runat="server">
                ...
                <div>
                    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Visible="false">
                        <LocalReport ReportPath="ReportViews\Declarations\StudentTextbookDeclaration.rdlc">
                            <DataSources>
                                <rsweb:ReportDataSource DataSourceId="sqlStudetnDeclarationByDepartmentID" Name="DataSet1" />
                            </DataSources>
                        </LocalReport>
                    </rsweb:ReportViewer>
                    <asp:SqlDataSource ID="sqlStudetnDeclarationByDepartmentID" runat="server" ConnectionString="<%$ ConnectionStrings:TbMISConnectionString %>"
                        SelectCommand="prReportGetStudentDeclarationByDepartmentID" SelectCommandType="StoredProcedure">
                        <SelectParameters>
